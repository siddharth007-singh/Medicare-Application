"use client"
import { setAvailabilitySlot } from '@/actions/doctor'
...
const AvailabilitySettingsPage = ({ slots }) => {
  const [showForm, setShowForm] = useState(false);
  const { loading, fn: submitSlot, data } = useFetch(setAvailabilitySlot);
            ...
            <form className="space-y-4 border border-emerald-900/20 rounded-md p-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input id="startTime" type="time" {...register("startTime", { required: "Start time is required" })} className="bg-background border-emerald-900/20" />
